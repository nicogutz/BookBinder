...
class RegistrationFormTypeTest extends TypeTestCase
{
    ...
    public function testBuildForm()
    {
        ...
        $this->assertEquals('test', $modal->getUsername());
        ...
        $this->assertEquals(' flex-fill mb-0 bg-transparent block mt-2 mb-2 mx-auto border-b-2 w-1/5 h-20 text-2xl outline-none rounded', $usernameField->getConfig()->getOption('attr')['class']);
        ...
        $this->assertEquals('bg-transparent block mt-10 mx-auto border-b-2 w-1/5 h-20 text-2xl outline-none rounded ', $plainPasswordField->getConfig()->getOption('attr')['class']);
